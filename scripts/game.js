...
class MainGameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.hazards.create(1200, 2225, "hazard_up").setScale(2, 1).refreshBody();
    this.hazards
      .create(1200 + 200, 2225, "hazard_up")
      .setScale(2, 1)
      .refreshBody();
    this.hazards
      .create(1200 + 400, 2225, "hazard_up")
      .setScale(2, 1)
      .refreshBody();
    this.hazards
      .create(1200 + 600, 2225, "hazard_up")
      .setScale(2, 1)
      .refreshBody();
    this.hazards
      .create(1200 + 700, 2225, "hazard_up")
      .setScale(2, 1)
      .refreshBody();

    this.hazards
      .create(1200 + 980, 2225, "hazard_up")
      .setScale(0.8, 1)
      .refreshBody();
    this.hazards
      .create(2250, 1950, "hazard_left")
      .setScale(0.7, 1)
      .refreshBody();
    ...
    this.hazards
      .create(3315 + 50, 1400, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 1500, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 1600, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 1700, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 1800, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 1900, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 2000, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 2100, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    this.hazards
      .create(3315 + 50, 2200, "hazard_right")
      .setScale(1.5, 1)
      .refreshBody();
    ...
    this.doors = [
      ...
      this.createDoor(13160 + 100, 560, "Room23")
        .setScale(0.3)
        .setDepth(1),
      this.createDoor(13160 - 1000, 2240, "Room24")
        .setScale(0.3)
        .setDepth(1),
    ];
