...
class Room23 extends Phaser.Scene {
  constructor() {
    super("Room23");
  }
  ...
  preload() {
    ...
    this.load.image("sisalto23", "assets/sisalto/betterwatchout.png");
  }
  ...
  create(data) {
    ...
    this.add.image(563, 297,"sisalto23").setScale(0.238, 0.175).setDepth(0.3);
