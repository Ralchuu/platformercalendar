...
class Room22 extends Phaser.Scene {
  constructor() {
    super("Room22");
  }
  ...
  preload() {
    ...
    this.load.image("sisalto22", "assets/sisalto/ihopeitsadog.jpg");
  }
  ...
  create(data) {
    ...
    this.add.image(563, 298,"sisalto22").setScale(0.165, 0.13).setDepth(0.3);
