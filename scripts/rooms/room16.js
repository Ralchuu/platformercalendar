...
class Room16 extends Phaser.Scene {
  constructor() {
    super("Room16");
  }
  ...
  preload() {
    ...
    this.load.image("sisalto16", "assets/sisalto/roughyear.png");
  }
  ...
  create(data) {
    ...
    //sisältö 
    this.add.image(562, 292, "sisalto16").setScale(0.239, 0.150).setDepth(0.3);
