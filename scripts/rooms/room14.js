...
class Room14 extends Phaser.Scene {
  constructor() {
    super("Room14");
  }
  ...
  preload() {
    ...
    this.load.image("aot", "assets/sisalto/aot.png"); // Picture
  }
  ...
  create(data) {
    ...
    this.add.image(563, 297,"aot").setScale(0.235, 0.152).setDepth(0.3); // Add the picture
