...
class Room11 extends Phaser.Scene {
  constructor() {
    super("Room11");
  }
  ...
  preload() {
    ...
    this.load.image("crmSanta", "assets/sisalto/crm_santa.png"); // Picture
  }
  ...
  create(data) {
    ...
    this.add.image(563, 297,"crmSanta").setScale(0.27, 0.27).setDepth(0.3); // Add the picture
